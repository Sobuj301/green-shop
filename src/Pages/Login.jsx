...
const Login = () => {
    return (
       <div className="flex justify-center mt-20">
         <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border mt-10">
            <div
            ...
            <div className="p-6 pt-0">
                ...
                <p className="flex justify-center mt-6 font-sans text-sm antialiased font-light leading-normal text-inherit">
                    ...
                    <NavLink to='/register' className="text-blue-600 underline ml-3">Please Sing Up</NavLink>
                </p>
            </div>
        </div>
       </div>
